CREATE TABLE `bd_az_framework`.`az_change_password` (
	`id_az_change_password` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_used_password` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Contraseña Usada',
	`v_id_az_user` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_password`
	ADD PRIMARY KEY (`id_az_change_password`),
	ADD KEY `IDX_id_az_change_password` (`id_az_change_password`),
	...
	ADD KEY `IDX_t_used_password` (`t_used_password`),
	ADD KEY `IDX_v_id_az_user` (`v_id_az_user`);

ALTER TABLE `bd_az_framework`.`az_change_password`
	MODIFY `id_az_change_password` bigint(255) NOT NULL AUTO_INCREMENT;