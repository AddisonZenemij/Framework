CREATE TABLE `bd_az_framework`.`pd_type_accrued` (
	`id_pd_type_accrued` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_type_accrued`
	ADD PRIMARY KEY (`id_pd_type_accrued`),
	ADD KEY `IDX_id_pd_type_accrued` (`id_pd_type_accrued`),
...
ALTER TABLE `bd_az_framework`.`pd_type_accrued`
	MODIFY `id_pd_type_accrued` bigint(255) NOT NULL AUTO_INCREMENT;