CREATE TABLE `bd_az_framework`.`pd_exchange_base_salary` (
	`id_pd_exchange_base_salary` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_base_salary`
	ADD PRIMARY KEY (`id_pd_exchange_base_salary`),
	ADD KEY `IDX_id_pd_exchange_base_salary` (`id_pd_exchange_base_salary`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_base_salary`
	MODIFY `id_pd_exchange_base_salary` bigint(255) NOT NULL AUTO_INCREMENT;