CREATE TABLE `bd_az_framework`.`pd_exchange_provider` (
	`id_pd_exchange_provider` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_pd_category_provider_t_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre',
	`v_id_pd_provider` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_provider`
	ADD PRIMARY KEY (`id_pd_exchange_provider`),
	ADD KEY `IDX_id_pd_exchange_provider` (`id_pd_exchange_provider`),
	...
	ADD KEY `IDX_t_pd_category_provider_t_name` (`t_pd_category_provider_t_name`),
	ADD KEY `IDX_v_id_pd_provider` (`v_id_pd_provider`);

ALTER TABLE `bd_az_framework`.`pd_exchange_provider`
	MODIFY `id_pd_exchange_provider` bigint(255) NOT NULL AUTO_INCREMENT;