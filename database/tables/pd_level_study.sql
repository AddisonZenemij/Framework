CREATE TABLE `bd_az_framework`.`pd_level_study` (
	`id_pd_level_study` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_level_study`
