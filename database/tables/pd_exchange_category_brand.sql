CREATE TABLE `bd_az_framework`.`pd_exchange_category_brand` (
	`id_pd_exchange_category_brand` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_pd_category_brand` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_category_brand`
	ADD PRIMARY KEY (`id_pd_exchange_category_brand`),
	ADD KEY `IDX_id_pd_exchange_category_brand` (`id_pd_exchange_category_brand`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_category_brand`
	MODIFY `id_pd_exchange_category_brand` bigint(255) NOT NULL AUTO_INCREMENT;