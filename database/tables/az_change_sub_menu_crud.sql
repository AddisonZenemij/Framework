CREATE TABLE `bd_az_framework`.`az_change_sub_menu_crud` (
	`id_az_change_sub_menu_crud` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`u_id_az_menu_crud_t_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre',
	`u_id_az_sub_under_t_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre',
	`v_id_az_sub_menu_crud` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_sub_menu_crud`
	ADD PRIMARY KEY (`id_az_change_sub_menu_crud`),
	ADD KEY `IDX_id_az_change_sub_menu_crud` (`id_az_change_sub_menu_crud`),
	...
	ADD KEY `IDX_u_id_az_menu_crud_t_name` (`u_id_az_menu_crud_t_name`),
	ADD KEY `IDX_u_id_az_sub_under_t_name` (`u_id_az_sub_under_t_name`),
	ADD KEY `IDX_v_id_az_sub_menu_crud` (`v_id_az_sub_menu_crud`);

ALTER TABLE `bd_az_framework`.`az_change_sub_menu_crud`
	MODIFY `id_az_change_sub_menu_crud` bigint(255) NOT NULL AUTO_INCREMENT;