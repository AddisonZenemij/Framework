CREATE TABLE `bd_az_framework`.`pd_document_type` (
	`id_pd_document_type` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_document_type`
