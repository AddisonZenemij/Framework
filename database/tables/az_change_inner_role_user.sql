CREATE TABLE `bd_az_framework`.`az_change_inner_role_user` (
	`id_az_change_inner_role_user` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_role` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id',
	`v_id_az_user` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id',
	`v_id_az_inner_role_user` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_inner_role_user`
	ADD PRIMARY KEY (`id_az_change_inner_role_user`),
	ADD KEY `IDX_id_az_change_inner_role_user` (`id_az_change_inner_role_user`),
	...
	ADD KEY `IDX_v_id_az_inner_role_user` (`v_id_az_inner_role_user`);

ALTER TABLE `bd_az_framework`.`az_change_inner_role_user`
	MODIFY `id_az_change_inner_role_user` bigint(255) NOT NULL AUTO_INCREMENT;