CREATE TABLE `bd_az_framework`.`az_menu_crud` (
	`id_az_menu_crud` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`az_menu_crud`
	ADD PRIMARY KEY (`id_az_menu_crud`),
	ADD KEY `IDX_id_az_menu_crud` (`id_az_menu_crud`),
...
ALTER TABLE `bd_az_framework`.`az_menu_crud`
	MODIFY `id_az_menu_crud` bigint(255) NOT NULL AUTO_INCREMENT;