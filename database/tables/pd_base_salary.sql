CREATE TABLE `bd_az_framework`.`pd_base_salary` (
	`id_pd_base_salary` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_value` decimal(26,0) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Salario Base Fijo'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_base_salary`
