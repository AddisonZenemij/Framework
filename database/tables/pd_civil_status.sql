CREATE TABLE `bd_az_framework`.`pd_civil_status` (
	`id_pd_civil_status` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_civil_status`
