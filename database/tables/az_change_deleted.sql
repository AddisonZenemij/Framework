CREATE TABLE `bd_az_framework`.`az_change_deleted` (
	`id_az_change_deleted` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_deleted` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_deleted`
	ADD PRIMARY KEY (`id_az_change_deleted`),
	ADD KEY `IDX_id_az_change_deleted` (`id_az_change_deleted`),
	...
	ADD KEY `IDX_v_id_az_deleted` (`v_id_az_deleted`);

ALTER TABLE `bd_az_framework`.`az_change_deleted`
	MODIFY `id_az_change_deleted` bigint(255) NOT NULL AUTO_INCREMENT;