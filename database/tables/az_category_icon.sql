CREATE TABLE `bd_az_framework`.`az_category_icon` (
	`id_az_category_icon` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`az_category_icon`
