CREATE TABLE `bd_az_framework`.`az_sub_menu_crud` (
	`id_az_sub_menu_crud` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_sub_under` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_sub_menu_crud`
	ADD PRIMARY KEY (`id_az_sub_menu_crud`),
	ADD KEY `IDX_id_az_sub_menu_crud` (`id_az_sub_menu_crud`),
	...
	ADD KEY `IDX_v_id_az_sub_under` (`v_id_az_sub_under`);

ALTER TABLE `bd_az_framework`.`az_sub_menu_crud`
	MODIFY `id_az_sub_menu_crud` bigint(255) NOT NULL AUTO_INCREMENT;