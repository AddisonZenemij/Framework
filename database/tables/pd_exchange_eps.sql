CREATE TABLE `bd_az_framework`.`pd_exchange_eps` (
	`id_pd_exchange_eps` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_eps`
	ADD PRIMARY KEY (`id_pd_exchange_eps`),
	ADD KEY `IDX_id_pd_exchange_eps` (`id_pd_exchange_eps`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_eps`
	MODIFY `id_pd_exchange_eps` bigint(255) NOT NULL AUTO_INCREMENT;