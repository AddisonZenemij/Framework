CREATE TABLE `bd_az_framework`.`az_change_level` (
	`id_az_change_level` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_level` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_level`
	ADD PRIMARY KEY (`id_az_change_level`),
	ADD KEY `IDX_id_az_change_level` (`id_az_change_level`),
	...
	ADD KEY `IDX_v_id_az_level` (`v_id_az_level`);

ALTER TABLE `bd_az_framework`.`az_change_level`
	MODIFY `id_az_change_level` bigint(255) NOT NULL AUTO_INCREMENT;