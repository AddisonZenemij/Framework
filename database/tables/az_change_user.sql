CREATE TABLE `bd_az_framework`.`az_change_user` (
	`id_az_change_user` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`az_change_user`
	ADD PRIMARY KEY (`id_az_change_user`),
	ADD KEY `IDX_id_az_change_user` (`id_az_change_user`),
...
ALTER TABLE `bd_az_framework`.`az_change_user`
	MODIFY `id_az_change_user` bigint(255) NOT NULL AUTO_INCREMENT;