CREATE TABLE `bd_az_framework`.`pd_exchange_transport_assistance` (
	`id_pd_exchange_transport_assistance` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_value` decimal(26,0) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Valor',
	`v_id_pd_transport_assistance` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_transport_assistance`
	ADD PRIMARY KEY (`id_pd_exchange_transport_assistance`),
	ADD KEY `IDX_id_pd_exchange_transport_assistance` (`id_pd_exchange_transport_assistance`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_transport_assistance`
	MODIFY `id_pd_exchange_transport_assistance` bigint(255) NOT NULL AUTO_INCREMENT;