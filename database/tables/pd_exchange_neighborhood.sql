CREATE TABLE `bd_az_framework`.`pd_exchange_neighborhood` (
	`id_pd_exchange_neighborhood` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_neighborhood`
	ADD PRIMARY KEY (`id_pd_exchange_neighborhood`),
	ADD KEY `IDX_id_pd_exchange_neighborhood` (`id_pd_exchange_neighborhood`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_neighborhood`
	MODIFY `id_pd_exchange_neighborhood` bigint(255) NOT NULL AUTO_INCREMENT;