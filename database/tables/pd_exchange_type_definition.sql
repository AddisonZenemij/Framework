CREATE TABLE `bd_az_framework`.`pd_exchange_type_definition` (
	`id_pd_exchange_type_definition` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_type_definition`
	ADD PRIMARY KEY (`id_pd_exchange_type_definition`),
	ADD KEY `IDX_id_pd_exchange_type_definition` (`id_pd_exchange_type_definition`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_type_definition`
	MODIFY `id_pd_exchange_type_definition` bigint(255) NOT NULL AUTO_INCREMENT;