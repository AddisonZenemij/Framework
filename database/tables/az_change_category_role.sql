CREATE TABLE `bd_az_framework`.`az_change_category_role` (
	`id_az_change_category_role` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_category_role` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_category_role`
	ADD PRIMARY KEY (`id_az_change_category_role`),
	ADD KEY `IDX_id_az_change_category_role` (`id_az_change_category_role`),
	...
	ADD KEY `IDX_v_id_az_category_role` (`v_id_az_category_role`);

ALTER TABLE `bd_az_framework`.`az_change_category_role`
	MODIFY `id_az_change_category_role` bigint(255) NOT NULL AUTO_INCREMENT;