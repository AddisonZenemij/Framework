CREATE TABLE `bd_az_framework`.`pd_exchange_worked_days` (
	`id_pd_exchange_worked_days` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_worked_days`
	ADD PRIMARY KEY (`id_pd_exchange_worked_days`),
	ADD KEY `IDX_id_pd_exchange_worked_days` (`id_pd_exchange_worked_days`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_worked_days`
	MODIFY `id_pd_exchange_worked_days` bigint(255) NOT NULL AUTO_INCREMENT;