CREATE TABLE `bd_az_framework`.`az_category_menu` (
	`id_az_category_menu` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`az_category_menu`
	ADD PRIMARY KEY (`id_az_category_menu`),
	ADD KEY `IDX_id_az_category_menu` (`id_az_category_menu`),
...
ALTER TABLE `bd_az_framework`.`az_category_menu`
	MODIFY `id_az_category_menu` bigint(255) NOT NULL AUTO_INCREMENT;