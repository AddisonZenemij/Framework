CREATE TABLE `bd_az_framework`.`az_temp` (
	`id_az_temp` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`az_temp`
	ADD PRIMARY KEY (`id_az_temp`),
	ADD KEY `IDX_id_az_temp` (`id_az_temp`),
...
ALTER TABLE `bd_az_framework`.`az_temp`
	MODIFY `id_az_temp` bigint(255) NOT NULL AUTO_INCREMENT;