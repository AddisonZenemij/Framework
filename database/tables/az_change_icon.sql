CREATE TABLE `bd_az_framework`.`az_change_icon` (
	`id_az_change_icon` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_az_category_icon_t_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre',
	`v_id_az_icon` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_icon`
	ADD PRIMARY KEY (`id_az_change_icon`),
	ADD KEY `IDX_id_az_change_icon` (`id_az_change_icon`),
	...
	ADD KEY `IDX_t_az_category_icon_t_name` (`t_az_category_icon_t_name`),
	ADD KEY `IDX_v_id_az_icon` (`v_id_az_icon`);

ALTER TABLE `bd_az_framework`.`az_change_icon`
	MODIFY `id_az_change_icon` bigint(255) NOT NULL AUTO_INCREMENT;