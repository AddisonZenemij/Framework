CREATE TABLE `bd_az_framework`.`pd_neighborhood` (
	`id_pd_neighborhood` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_neighborhood`
