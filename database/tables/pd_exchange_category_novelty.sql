CREATE TABLE `bd_az_framework`.`pd_exchange_category_novelty` (
	`id_pd_exchange_category_novelty` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_category_novelty`
	ADD PRIMARY KEY (`id_pd_exchange_category_novelty`),
	ADD KEY `IDX_id_pd_exchange_category_novelty` (`id_pd_exchange_category_novelty`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_category_novelty`
	MODIFY `id_pd_exchange_category_novelty` bigint(255) NOT NULL AUTO_INCREMENT;