CREATE TABLE `bd_az_framework`.`pd_worked_period` (
	`id_pd_worked_period` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_worked_period`
