CREATE TABLE `bd_az_framework`.`pd_messaging_type` (
	`id_pd_messaging_type` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_messaging_type`
