CREATE TABLE `bd_az_framework`.`az_log` (
	`id_az_log` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_log` longtext COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Log'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_log`
