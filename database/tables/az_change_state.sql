CREATE TABLE `bd_az_framework`.`az_change_state` (
	`id_az_change_state` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_state` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_state`
	ADD PRIMARY KEY (`id_az_change_state`),
	ADD KEY `IDX_id_az_change_state` (`id_az_change_state`),
	...
	ADD KEY `IDX_v_id_az_state` (`v_id_az_state`);

ALTER TABLE `bd_az_framework`.`az_change_state`
	MODIFY `id_az_change_state` bigint(255) NOT NULL AUTO_INCREMENT;