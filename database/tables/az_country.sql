CREATE TABLE `bd_az_framework`.`az_country` (
	`id_az_country` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`az_country`
	ADD PRIMARY KEY (`id_az_country`),
	ADD KEY `IDX_id_az_country` (`id_az_country`),
...
ALTER TABLE `bd_az_framework`.`az_country`
	MODIFY `id_az_country` bigint(255) NOT NULL AUTO_INCREMENT;