CREATE TABLE `bd_az_framework`.`pd_exchange_daily_activities` (
	`id_pd_exchange_daily_activities` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_date` date COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Fecha',
	`t_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre',
	`v_id_pd_daily_activities` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_daily_activities`
	ADD PRIMARY KEY (`id_pd_exchange_daily_activities`),
	ADD KEY `IDX_id_pd_exchange_daily_activities` (`id_pd_exchange_daily_activities`),
	...
	ADD KEY `IDX_t_date` (`t_date`),
	ADD KEY `IDX_t_name` (`t_name`),
	ADD KEY `IDX_v_id_pd_daily_activities` (`v_id_pd_daily_activities`);

ALTER TABLE `bd_az_framework`.`pd_exchange_daily_activities`
	MODIFY `id_pd_exchange_daily_activities` bigint(255) NOT NULL AUTO_INCREMENT;