CREATE TABLE `bd_az_framework`.`pd_change_diadem` (
	`id_pd_change_diadem` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_change_diadem`
