CREATE TABLE `bd_az_framework`.`pd_exchange_level_study` (
	`id_pd_exchange_level_study` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_level_study`
	ADD PRIMARY KEY (`id_pd_exchange_level_study`),
	ADD KEY `IDX_id_pd_exchange_level_study` (`id_pd_exchange_level_study`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_level_study`
	MODIFY `id_pd_exchange_level_study` bigint(255) NOT NULL AUTO_INCREMENT;