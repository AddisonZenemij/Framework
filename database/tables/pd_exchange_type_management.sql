CREATE TABLE `bd_az_framework`.`pd_exchange_type_management` (
	`id_pd_exchange_type_management` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_type_management`
	ADD PRIMARY KEY (`id_pd_exchange_type_management`),
	ADD KEY `IDX_id_pd_exchange_type_management` (`id_pd_exchange_type_management`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_type_management`
	MODIFY `id_pd_exchange_type_management` bigint(255) NOT NULL AUTO_INCREMENT;