CREATE TABLE `bd_az_framework`.`az_change_category_icon` (
	`id_az_change_category_icon` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_az_category_icon` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`az_change_category_icon`
	ADD PRIMARY KEY (`id_az_change_category_icon`),
	ADD KEY `IDX_id_az_change_category_icon` (`id_az_change_category_icon`),
...
ALTER TABLE `bd_az_framework`.`az_change_category_icon`
	MODIFY `id_az_change_category_icon` bigint(255) NOT NULL AUTO_INCREMENT;