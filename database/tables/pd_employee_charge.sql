CREATE TABLE `bd_az_framework`.`pd_employee_charge` (
	`id_pd_employee_charge` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_employee_charge`
	ADD PRIMARY KEY (`id_pd_employee_charge`),
	ADD KEY `IDX_id_pd_employee_charge` (`id_pd_employee_charge`),
...
ALTER TABLE `bd_az_framework`.`pd_employee_charge`
	MODIFY `id_pd_employee_charge` bigint(255) NOT NULL AUTO_INCREMENT;