CREATE TABLE `bd_az_framework`.`pd_category_brand` (
	`id_pd_category_brand` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_category_brand`
