CREATE TABLE `bd_az_framework`.`pd_birth_place` (
	`id_pd_birth_place` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_birth_place`
	ADD PRIMARY KEY (`id_pd_birth_place`),
	ADD KEY `IDX_id_pd_birth_place` (`id_pd_birth_place`),
...
ALTER TABLE `bd_az_framework`.`pd_birth_place`
	MODIFY `id_pd_birth_place` bigint(255) NOT NULL AUTO_INCREMENT;