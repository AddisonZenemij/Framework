CREATE TABLE `bd_az_framework`.`pd_exchange_brand` (
	`id_pd_exchange_brand` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_pd_category_brand_t_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre',
	`v_id_pd_brand` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_brand`
	ADD PRIMARY KEY (`id_pd_exchange_brand`),
	ADD KEY `IDX_id_pd_exchange_brand` (`id_pd_exchange_brand`),
	...
	ADD KEY `IDX_t_pd_category_brand_t_name` (`t_pd_category_brand_t_name`),
	ADD KEY `IDX_v_id_pd_brand` (`v_id_pd_brand`);

ALTER TABLE `bd_az_framework`.`pd_exchange_brand`
	MODIFY `id_pd_exchange_brand` bigint(255) NOT NULL AUTO_INCREMENT;