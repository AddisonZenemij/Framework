CREATE TABLE `bd_az_framework`.`pd_exchange_pension` (
	`id_pd_exchange_pension` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_pension`
	ADD PRIMARY KEY (`id_pd_exchange_pension`),
	ADD KEY `IDX_id_pd_exchange_pension` (`id_pd_exchange_pension`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_pension`
	MODIFY `id_pd_exchange_pension` bigint(255) NOT NULL AUTO_INCREMENT;