CREATE TABLE `bd_az_framework`.`pd_exchange_civil_status` (
	`id_pd_exchange_civil_status` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_civil_status`
	ADD PRIMARY KEY (`id_pd_exchange_civil_status`),
	ADD KEY `IDX_id_pd_exchange_civil_status` (`id_pd_exchange_civil_status`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_civil_status`
	MODIFY `id_pd_exchange_civil_status` bigint(255) NOT NULL AUTO_INCREMENT;