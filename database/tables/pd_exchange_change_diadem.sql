CREATE TABLE `bd_az_framework`.`pd_exchange_change_diadem` (
	`id_pd_exchange_change_diadem` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`t_date_change` date COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Fecha Cambio',
	`u_id_pd_data_personal_t_names` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id',
	`u_id_pd_data_personal_t_surnames` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id',
	`v_id_pd_change_diadem` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_change_diadem`
	ADD PRIMARY KEY (`id_pd_exchange_change_diadem`),
	ADD KEY `IDX_id_pd_exchange_change_diadem` (`id_pd_exchange_change_diadem`),
	...
	ADD KEY `IDX_u_id_pd_data_personal_t_names` (`u_id_pd_data_personal_t_names`),
	ADD KEY `IDX_u_id_pd_data_personal_t_surnames` (`u_id_pd_data_personal_t_surnames`),
	ADD KEY `IDX_v_id_pd_change_diadem` (`v_id_pd_change_diadem`);

ALTER TABLE `bd_az_framework`.`pd_exchange_change_diadem`
	MODIFY `id_pd_exchange_change_diadem` bigint(255) NOT NULL AUTO_INCREMENT;