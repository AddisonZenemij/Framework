CREATE TABLE `bd_az_framework`.`pd_exchange_document_type` (
	`id_pd_exchange_document_type` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_document_type`
	ADD PRIMARY KEY (`id_pd_exchange_document_type`),
	ADD KEY `IDX_id_pd_exchange_document_type` (`id_pd_exchange_document_type`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_document_type`
	MODIFY `id_pd_exchange_document_type` bigint(255) NOT NULL AUTO_INCREMENT;