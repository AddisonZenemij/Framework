CREATE TABLE `bd_az_framework`.`pd_exchange_worked_period` (
	`id_pd_exchange_worked_period` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
...
ALTER TABLE `bd_az_framework`.`pd_exchange_worked_period`
	ADD PRIMARY KEY (`id_pd_exchange_worked_period`),
	ADD KEY `IDX_id_pd_exchange_worked_period` (`id_pd_exchange_worked_period`),
...
ALTER TABLE `bd_az_framework`.`pd_exchange_worked_period`
	MODIFY `id_pd_exchange_worked_period` bigint(255) NOT NULL AUTO_INCREMENT;