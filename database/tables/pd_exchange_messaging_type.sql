CREATE TABLE `bd_az_framework`.`pd_exchange_messaging_type` (
	`id_pd_exchange_messaging_type` bigint(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Id',
	...
	`v_id_pd_messaging_type` bigint(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

ALTER TABLE `bd_az_framework`.`pd_exchange_messaging_type`
	ADD PRIMARY KEY (`id_pd_exchange_messaging_type`),
	ADD KEY `IDX_id_pd_exchange_messaging_type` (`id_pd_exchange_messaging_type`),
	...
	ADD KEY `IDX_v_id_pd_messaging_type` (`v_id_pd_messaging_type`);

ALTER TABLE `bd_az_framework`.`pd_exchange_messaging_type`
	MODIFY `id_pd_exchange_messaging_type` bigint(255) NOT NULL AUTO_INCREMENT;