<?php
	...
	define('data_base_name', 'bd_pd_itau_castigada');
		...
		if (isset($_SESSION['authenticated_user_id'])) {
			if (true == $df_sql_users) {
				foreach ($df_sql_users as $key => $value) {
					?>
						<a href="http://192.168.6.58:8090/framework/pditaucastigada/definition/<?php echo $_GET['field_identification']; ?>/?field_session=<?php echo $df_sql_users[$key][d_users_id]; ?>">
							<span>Acceder</span>
						</a>
					<?php
				}
