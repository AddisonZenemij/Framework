<?php
	...
	//------------------------------------------------
	final class m_pd_itau_castigadaModel extends Models implements OCREND {
		/*=========================================================================================================================*/
		public function __construct() {
			parent::__construct(db_bd_pd_itau_castigada, DATABASE['motor'], true);
		}
		...
		final public function sql_controller_users() : array {
			...
			$var_sql = $this->db->query("
				SELECT * FROM " . t_itau_c_users . "
				WHERE " . d_itau_c_users_id . " = '" . $_GET['field_session'] . "'
			");
		...
		final public function sql_controller_management() {
			# Seleccionar los registros de la tabla
			return $this->db->query("
				SELECT * FROM " . t_itau_c_he01_t_c . "
				WHERE " . d_itau_c_he01_t_c_numeroid . " = '" . $_GET['field_identification'] . "'
				ORDER BY " . d_itau_c_he01_t_c_fecha . " DESC,
					" . d_itau_c_he01_t_c_hora . " DESC
			");
		}
		...
		final public function sql_controller_product() {
			# Seleccionar los registros de la tabla
			return $this->db->query("
				SELECT * FROM " . t_itau_c_he01_p_d_c . "
				WHERE " . d_itau_c_he01_p_d_c_numeroid_t . " = '" . $_GET['field_identification'] . "'
			");
		}
		...
		final public function sql_controller_tipify() : array {
			# Seleccionar los registros de la tabla
			$var_sql = $this->db->query("
				SELECT * FROM " . t_itau_c_he01_d_d_c . "
				WHERE " . d_itau_c_he01_d_d_c_deleted . " = '0'
					AND " . d_itau_c_he01_d_d_c_numeroid . " = '" . $_GET['field_identification'] . "'
				LIMIT 1
			");
			$var_result = $var_sql->fetchAll();
			$var_sql->closeCursor();
		...
		final public function sql_report_management_all() {
			...
			if (isset($_GET['field_date_from']) != '' && isset($_GET['field_date_to']) != '') {
				return $this->db->query("
					SELECT * FROM " . t_itau_c_he01_t_c . "
					WHERE " . d_itau_c_he01_t_c_fecha . " >= '" . $_GET['field_date_from'] . "'
						AND " . d_itau_c_he01_t_c_fecha . " <= '" . $_GET['field_date_to'] . "'
					ORDER BY " . d_itau_c_he01_t_c_fecha . " ASC,
						" . d_itau_c_he01_t_c_hora . " ASC
				");
			}
		}
		...
		final private function error_sql_update_all_pd_itau_castigada_novelty(array $data) {
			try {
				/*-----------------------------------------------------------------------------------------------------------------*/
		...
		/*=========================================================================================================================*/
		# Query Sql Update
		final public function sql_update_all_pd_itau_castigada_novelty(array $data) : array {
			$var_error = $this->error_sql_update_all_pd_itau_castigada_novelty($data);
			if (!is_bool($var_error)) {
				return $var_error;
			}
			# Linea de codigo con una variable y array para actualizar los datos en la tabla
			$var_array = array(
				d_itau_c_he01_d_d_c_direccion => $data['field_address_main'],
				d_itau_c_he01_d_d_c_direccion2 => $data['field_work_direction'],
				d_itau_c_he01_d_d_c_correo => $data['field_email_1'],
				d_itau_c_he01_d_d_c_correo2 => $data['field_email_2'],
				d_itau_c_he01_d_d_c_telefono => $data['field_phone_fixed_1'],
				d_itau_c_he01_d_d_c_telefono2 => $data['field_phone_fixed_2'],
				d_itau_c_he01_d_d_c_telefono3 => $data['field_phone_fixed_3'],
				d_itau_c_he01_d_d_c_celular => $data['field_phone_fixed_4'],
				d_itau_c_he01_d_d_c_nom_ref_fam1 => $data['field_ref_family_names_surnames_1'],
				d_itau_c_he01_d_d_c_dir_ref_fam1 => $data['field_ref_family_address_1'],
				d_itau_c_he01_d_d_c_tel_ref_fam1 => $data['field_ref_family_phone_fixed_1'],
				d_itau_c_he01_d_d_c_cel_ref_fam1 => $data['field_ref_family_phone_movil_1'],
				d_itau_c_he01_d_d_c_nom_ref_fam2 => $data['field_ref_family_names_surnames_2'],
				d_itau_c_he01_d_d_c_dir_ref_fam2 => $data['field_ref_family_address_2'],
				d_itau_c_he01_d_d_c_tel_ref_fam2 => $data['field_ref_family_phone_fixed_2'],
				d_itau_c_he01_d_d_c_cel_ref_fam2 => $data['field_ref_family_phone_movil_2'],
				d_itau_c_he01_d_d_c_nom_ref_fam3 => $data['field_ref_family_names_surnames_3'],
				d_itau_c_he01_d_d_c_dir_ref_fam3 => $data['field_ref_family_address_3'],
				d_itau_c_he01_d_d_c_tel_ref_fam3 => $data['field_ref_family_phone_fixed_3'],
				d_itau_c_he01_d_d_c_cel_ref_fam3 => $data['field_ref_family_phone_movil_3'],
				d_itau_c_he01_d_d_c_nom_ref_per1 => $data['field_ref_personal_names_surnames_1'],
				d_itau_c_he01_d_d_c_dir_ref_per1 => $data['field_ref_personal_address_1'],
				d_itau_c_he01_d_d_c_tel_ref_per1 => $data['field_ref_personal_phone_fixed_1'],
				d_itau_c_he01_d_d_c_cel_ref_per1 => $data['field_ref_personal_phone_movil_1'],
				d_itau_c_he01_d_d_c_nom_ref_per2 => $data['field_ref_personal_names_surnames_2'],
				d_itau_c_he01_d_d_c_dir_ref_per2 => $data['field_ref_personal_address_2'],
				d_itau_c_he01_d_d_c_tel_ref_per2 => $data['field_ref_personal_phone_fixed_2'],
				d_itau_c_he01_d_d_c_cel_ref_per2 => $data['field_ref_personal_phone_movil_2'],
				d_itau_c_he01_d_d_c_nom_ref_com1 => $data['field_ref_commercial_names_surnames_1'],
				d_itau_c_he01_d_d_c_dir_ref_com1 => $data['field_ref_commercial_address_1'],
				d_itau_c_he01_d_d_c_tel_ref_com1 => $data['field_ref_commercial_phone_fixed_1'],
				d_itau_c_he01_d_d_c_cel_ref_com1 => $data['field_ref_commercial_phone_movil_1'],
				d_itau_c_he01_d_d_c_nom_ref_com2 => $data['field_ref_commercial_names_surnames_2'],
				d_itau_c_he01_d_d_c_dir_ref_com2 => $data['field_ref_commercial_address_2'],
				d_itau_c_he01_d_d_c_tel_ref_com2 => $data['field_ref_commercial_phone_fixed_2'],
				d_itau_c_he01_d_d_c_cel_ref_com2 => $data['field_ref_commercial_phone_movil_2']
			);
			# Query Sql Update: Actualizar datos en la tabla con sus campos respectivos y asignados segun el id
			$this->db->update(t_itau_c_he01_d_d_c, $var_array, d_itau_c_he01_d_d_c_numeroid . " = '" . $data['field_novelty_identification'] . "'");
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_create_all_pd_itau_castigada_proyection(array $data) {
			try {
				/*-----------------------------------------------------------------------------------------------------------------*/
				if (isset($_SESSION['pe_time']) and end($_SESSION['pe_time']) >= time()) {
					throw new Exception('No puedes realizar tantas acciones seguidas.');
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_create_all_pd_itau_castigada_proyection(array $data) : array {
			$var_error = $this->error_sql_create_all_pd_itau_castigada_proyection($data);
			if (!is_bool($var_error)) {
				return $var_error;
			}
			/*-----------------------------------------------------------------------------------------------------------------*/
			if ($data['field_projection_last_payment_value'] != '' && ($data['field_projection_pay_date'] != '' || $data['field_projection_pay_date'] != 'aaaa-mm-dd')) {
				$var_array = array(
					d_itau_c_he01_p_p_c_nombre => $data['field_projection_name'],
					d_itau_c_he01_p_p_c_numeroid => $data['field_projection_identification'],
					d_itau_c_he01_p_p_c_tipocartera => $data['field_projection_wallet_type'],
					d_itau_c_he01_p_p_c_fechapago => $data['field_projection_pay_date'],
					d_itau_c_he01_p_p_c_pago => str_replace(',','',$data['field_projection_last_payment_value']),
					d_itau_c_he01_p_p_c_fechaproyeccion => $data['field_projection_date_projection'],
					d_itau_c_he01_p_p_c_proyeccion => str_replace(',','',$data['field_projection_projection_value']),
					d_itau_c_he01_p_p_c_asesor => $data['field_projection_asesor'],
					d_itau_c_he01_p_p_c_idasesor => $data['field_projection_asesor'],
					d_itau_c_he01_p_p_c_saldo_capital => str_replace(',','',$data['field_projection_capital_balance']),
					d_itau_c_he01_p_p_c_fecha => date("Y-m-d"),
					d_itau_c_he01_p_p_c_hora => date("H:i:s")
				);
				# Valores y campos para actualizar con valores recibidos por POST y Ajax
				$var_update = array(
					d_itau_c_he01_d_d_c_pago => str_replace(',','',$data['field_projection_last_payment_value']),
					d_itau_c_he01_d_d_c_fechapago => $data['field_projection_pay_date'],
					d_itau_c_he01_d_d_c_proyeccion => str_replace(',','',$data['field_projection_projection_value']),
					d_itau_c_he01_d_d_c_fechaproyeccion => $data['field_projection_date_projection']
				);
			} else {
				$var_array = array(
					d_itau_c_he01_p_p_c_nombre => $data['field_projection_name'],
			...
			/*-----------------------------------------------------------------------------------------------------------------*/
			# Query Sql Update: Actualizar datos en la tabla con sus campos respectivos y asignados segun el id
			$this->db->update(t_itau_c_he01_d_d_c, $var_update, d_itau_c_he01_d_d_c_numeroid . " = '" . $data['field_projection_identification'] . "'");
			# Query Sql Insert: Insertar datos en la tabla con sus campos respectivos y con incrementacion de id
			$this->db->insert(t_itau_c_he01_p_p_c, $var_array);
			/*-----------------------------------------------------------------------------------------------------------------*/
		...
		/*=========================================================================================================================*/
		# Control Errores Update
		final private function error_sql_create_all_pd_itau_castigada_tipify(array $data) {
			try {
				/*-----------------------------------------------------------------------------------------------------------------*/
				if (isset($_SESSION['pe_time']) and end($_SESSION['pe_time']) >= time()) {
					throw new Exception('No puedes realizar tantas acciones seguidas.');
		...
		/*=========================================================================================================================*/
		# Query Sql Insert
		final public function sql_create_all_pd_itau_castigada_tipify(array $data) : array {
			$var_error = $this->error_sql_create_all_pd_itau_castigada_tipify($data);
			if (!is_bool($var_error)) {
				return $var_error;
			}
			$var_insert = array(
				d_itau_c_he01_t_c_nombre => $data['field_tipify_name'],
				d_itau_c_he01_t_c_numeroid => $data['field_tipify_identification'],
				d_itau_c_he01_t_c_tipificacion => $data['field_tipify_value'],
				d_itau_c_he01_t_c_detalle => $data['field_tipify_detail'],
				d_itau_c_he01_t_c_telcontacto => str_replace(',','',$data['field_tipify_phone']),
				d_itau_c_he01_t_c_campaign => $data['field_tipify_campaign'],
				d_itau_c_he01_t_c_endeudamientocastigo => str_replace(',','',$data['field_tipify_capital_balance']),
				d_itau_c_he01_t_c_idasesor => $data['field_tipify_asesor'],
				d_itau_c_he01_t_c_asesor => $data['field_tipify_asesor'],
				d_itau_c_he01_t_c_fecha => date("Y-m-d"),
				d_itau_c_he01_t_c_hora => date("H:i:s"),
				d_itau_c_he01_t_c_tipocartera => $data['field_tipify_wallet_type'],
				d_itau_c_he01_t_c_razonnopago => $data['field_tipify_reason_for_non_payment'],
				d_itau_c_he01_t_c_t_definition => $data['field_tipify_definition']
			);
			$this->db->insert(t_itau_c_he01_t_c, $var_insert);
			# Linea de codigo con una variable y array para actualizar los datos en la tabla
			$var_update = array(
				d_itau_c_he01_d_d_c_barrido => $data['field_tipify_value'],
				d_itau_c_he01_d_d_c_ulttipificacion => $data['field_tipify_value'],
				d_itau_c_he01_d_d_c_fechaultimatip => date("Y-m-d"),
				d_itau_c_he01_d_d_c_seguimiento => $data['field_tipify_tracing']
			);
			# Query Sql Update: Actualizar datos en la tabla con sus campos respectivos y asignados segun el id
			$this->db->update(t_itau_c_he01_d_d_c, $var_update, d_itau_c_he01_d_d_c_numeroid . " = '" . $data['field_tipify_identification'] . "'");
			# Retornar el mensaje de exito una vez se hayan actualizado los datos correctamente
			return array('success' => 1, 'message' => '<b>Exito:</b> Registro completado correctamente.');
		}
